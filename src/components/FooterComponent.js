                    ...
                    <div className="col-md-4">
                        <div className="latest-posts"><a href="#">
                            <div className="post d-flex align-items-center">
                                ...
                                <div className="title"><strong>Hotels for all budgets</strong><span
                                    className="date last-meta">October 26, 2016</span></div>
                            </div>
                        </a><a href="#">
                            <div className="post d-flex align-items-center">
                                <div className="image"><img src="/img/small-thumbnail-2.jpg" alt="..."
                                                            className="img-fluid" /></div>
                                <div className="title"><strong>Great street atrs in London</strong><span
                                    className="date last-meta">October 26, 2016</span></div>
                            </div>
                        </a><a href="#">
                            <div className="post d-flex align-items-center">
                                <div className="image"><img src="/img/small-thumbnail-3.jpg" alt="..."
                                                            className="img-fluid" /></div>
                                <div className="title"><strong>Best coffee shops in Sydney</strong><span
                                    className="date last-meta">October 26, 2016</span></div>
                            </div>
                        </a></div>
                    </div>
